...
const SITE_CONFIG = {
    ...
    whatsapp: {
        ...
        oracleMessage: (cardNames) => `Hola Maestra Aurora, acabo de realizar la tirada del Oráculo Sagrado y salieron las cartas: [${cardNames}]. Deseo mi interpretación espiritual y ayuda personalizada.`,
